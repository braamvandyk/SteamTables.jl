...
@testset "Region 3 - backwards equations for P and T             " begin
    include("testreg3Px.jl")
end
...
@testset "Region 5 - backwards equations for P and T             " begin
    include("testreg5Px.jl")
end
